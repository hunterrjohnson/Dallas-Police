...
#np.percentile(df.Address.value_counts(), np.linspace(1,100,100))
#np.percentile(df.groupby(by='Address')['Address'].count(), np.linspace(1,100,100))
...
# ### Variable types, names, and column order
